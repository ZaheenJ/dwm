...
[noborder](https://dwm.suckless.org/patches/noborder/) - Removes border when there is only one window
...
[rotate stack](https://dwm.suckless.org/patches/rotatestack/) - Rotates all windows clockwise or counter clockwise

[stackmfack](https://dwm.suckless.org/patches/stackmfact/) - Change size of stack window in stack

[sticky](https://dwm.suckless.org/patches/sticky/) - Make window appear on all tags

[warp](https://dwm.suckless.org/patches/warp/) - Move mouse to center of new focused window
